...
int main(int argc,char ** argv)
{
    ...
    */
    ...
    plintf("%d complex ffts took %gs, real took %gs\n",NUMFFTS,tfft,trfft);
    ...
    /*
    plintf(" results from inverse kiss_fft : (%f,%f), (%f,%f), (%f,%f), (%f,%f), (%f,%f) ...\n "
    ...
    plintf(" results from inverse kiss_fftr: %f,%f,%f,%f,%f ... \n"
